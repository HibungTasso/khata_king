...
class _ToggleCreditDebitState extends State<ToggleCreditDebit> {
  ...
  void initState() {
    super.initState();
    widget.onChange('credit'); //By default set credit
  }
                  ...
                  LayoutBuilder(
                    builder: (ctx, constraints) {
                      return AnimatedAlign(
                        ...
                        child: Container(
                          width:
                              constraints.maxWidth / 2, //Dynamic UI Slider 50%
                          decoration: BoxDecoration(
                            color: Colors.white,
                            borderRadius: BorderRadius.circular(10),
                            boxShadow: [
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            ...
                            widget.onChange(
                              "credit",
                            ); //Notify Parent -> in AddCustomerScreen
                          },
                          child: Center(
                            child: Text(
                              "You Gave",
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            ...
                            widget.onChange(
                              "debit",
                            ); //Notify Parent -> in AddScreenScreen
                          },
                          child: Center(
                            child: Text(
                              "You Got",
